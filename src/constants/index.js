...
export const projects = [
    {
        ...
        link: 'import { school, college, degree, kopykitab, webdev } from "../assets/images";
import {
    css,
    estate,
    express,
...
export const projects = [
    {
        ...
        name: 'Social Media App',
        description: 'Built a complete clone of Instagram, allowing users to share photos and connect with friends in a familiar social media environment.',
        link: 'https://social-media-app-hqby.vercel.app/',
    },
    {
        iconUrl: summiz,
    ...
    },
    {
        ...
        theme: 'btn-back-blue',
        name: 'Movix',
        description: 'Movix, a React-based movie database, integrates Redux and TMDB. Browse and discover films effortlessly, sorting by IMDb rating, genre, and more. Enjoy!',
    ...
    },
    {
        ...
        theme: 'btn-back-pink',
        name: 'Todo App',
        description: 'This is a powerful Todo App built with React Next.js. Utilize Firebase as the backend for seamless user data storage and management.',
